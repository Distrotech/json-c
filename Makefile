...
DIST_COMMON = $(srcdir)/Makefile.am.inc INSTALL NEWS README AUTHORS \
	ChangeLog $(srcdir)/Makefile.in $(srcdir)/Makefile.am \
	$(top_srcdir)/configure $(am__configure_deps) \
	$(srcdir)/config.h.in $(srcdir)/json_config.h.in \
	$(srcdir)/json.pc.in $(srcdir)/json-c.pc.in \
	$(srcdir)/json-c-uninstalled.pc.in depcomp \
	$(libjson_cinclude_HEADERS) COPYING config.guess config.sub \
...
libjson_la_LINK = $(LIBTOOL) $(AM_V_lt) --tag=CC $(AM_LIBTOOLFLAGS) \
	$(LIBTOOLFLAGS) --mode=link $(CCLD) $(AM_CFLAGS) $(CFLAGS) \
...
ACLOCAL = ${SHELL} /usr/src/json-c/json-c/missing aclocal-1.13
AMTAR = $${TAR-tar}
AM_DEFAULT_VERBOSITY = 1
AR = ar
AUTOCONF = ${SHELL} /usr/src/json-c/json-c/missing autoconf
AUTOHEADER = ${SHELL} /usr/src/json-c/json-c/missing autoheader
AUTOMAKE = ${SHELL} /usr/src/json-c/json-c/missing automake-1.13
AWK = gawk
CC = gcc
...
LN_S = ln -s
LTLIBOBJS = 
MAKEINFO = ${SHELL} /usr/src/json-c/json-c/missing makeinfo
MANIFEST_TOOL = :
...
STRIP = strip
VERSION = 0.11
abs_builddir = /usr/src/json-c/json-c
abs_srcdir = /usr/src/json-c/json-c
abs_top_builddir = /usr/src/json-c/json-c
abs_top_srcdir = /usr/src/json-c/json-c
ac_ct_AR = ar
ac_ct_CC = gcc
ac_ct_DUMPBIN = 
am__include = include
...
install_sh = ${SHELL} /usr/src/json-c/json-c/install-sh
...
libjson.la: $(libjson_la_OBJECTS) $(libjson_la_DEPENDENCIES) $(EXTRA_libjson_la_DEPENDENCIES) 
	$(AM_V_CCLD)$(libjson_la_LINK) $(am_libjson_la_rpath) $(libjson_la_OBJECTS) $(libjson_la_LIBADD) $(LIBS)
